...
class MentorRecommendation(BaseModel):
    ...
    filter_type: Literal["job", "skill", "response_rate", "fallback_response_rate"] | None = Field(
        default=None,
        description="필터 타입 (job: 직무 일치, skill: 기술스택 일치, response_rate: 응답률 기반, fallback_response_rate: 추천 실패 시 응답률 fallback)",
    )
